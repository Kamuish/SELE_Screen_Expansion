...
Program\ files/EEPROM_test.o: ../Program\ files/EEPROM_test.c
	...
	avr-gcc -I"/home/andre/eclipse-workspace/project_ICARUS/src/screen_expansion_project/Header files" -Wall -Os -fpack-struct -fshort-enums -ffunction-sections -fdata-sections -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=atmega328p -DF_CPU=14745600UL -MMD -MP -MF"Program files/EEPROM_test.d" -MT"Program\ files/EEPROM_test.d" -c -o "$@" "$<"
